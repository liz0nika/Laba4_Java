...
public Set<String> getSubsequentSentencesWords() - повертає унікальні слова з усіх речень тексту, крім першого. Проходить по реченнях, починаючи з другого і викликає метод getWordsAsStrings() кожного речення, щоб отримати його слова у вигляді рядків.
